...
!(function (e, t) {
  ...
  const t = (e) => {
    ...
    O = () => {
      const e = Array.from(
          b().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])'),
        ).sort((e, t) => {
      ...
      new Promise((t) => {
        ...
        (ee.restoreFocusTimeout = setTimeout(() => {
          ee.previousActiveElement instanceof HTMLElement
            ? (ee.previousActiveElement.focus(), (ee.previousActiveElement = null))
            ...
            (function (e, t, o, i) {
              ...
              R([e, t, o], n.styled),
                i.confirmButtonColor &&
                  ((e.style.backgroundColor = i.confirmButtonColor), R(e, n['default-outline']));
              i.denyButtonColor &&
                ((t.style.backgroundColor = i.denyButtonColor), R(t, n['default-outline']));
              i.cancelButtonColor &&
                ((o.style.backgroundColor = i.cancelButtonColor), R(o, n['default-outline']));
            })(i, s, r, o),
            o.reverseButtons &&
              (o.toast
                ? (e.insertBefore(r, i), e.insertBefore(s, i))
                : (e.insertBefore(r, t), e.insertBefore(s, t), e.insertBefore(i, t)));
        })(o, i, t),
        I(i, t.loaderHtml),
        q(i, t, 'loader');
    };
  ...
  (Ce.text =
    ...
    Ce.tel =
    Ce.url =
      (e, t) => (ve(e, t.inputValue), ye(e, e, t), be(e, t), (e.type = t.input), e)),
  ...
  const Ae = (t, o) => {
    ...
    $e = (e, t) => {
      (e.className = `${n.popup} ${J(e) ? t.showClass.popup : ''}`),
        t.toast
          ? (R([document.documentElement, document.body], n['toast-shown']), R(e, n.toast))
          : R(e, n.modal),
        q(e, t, 'popup'),
    ...
    Le = (t, i) => {
      ((e, t) => {
        const n = g(),
          o = b();
        t.toast
          ? (W(n, 'width', t.width), (o.style.width = '100%'), o.insertBefore(E(), y()))
          : W(o, 'width', t.width),
          ...
          t.progressSteps && 0 !== t.progressSteps.length
            ? (z(o),
              ...
              t.progressSteps.forEach((e, i) => {
                ...
                if (
                  (o.appendChild(s),
                  i === t.currentProgressStep && R(s, n['active-progress-step']),
  ...
  const Me = () => B() && B().click(),
    ...
    De = (e, t) => {
      const n = O();
      if (n.length)
        return (e += t) === n.length ? (e = 0) : -1 === e && (e = n.length - 1), void n[e].focus();
      b().focus();
    },
  ...
  const it = (t) => {
    ...
    rt = (e, t, n) => {
      ...
      'function' == typeof n.willClose && n.willClose(t),
        i ? at(e, t, o, n.returnFocus, n.didClose) : tt(e, o, n.returnFocus, n.didClose);
    },
    at = (e, t, n, o, i) => {
      (ee.swalCloseEventFinishedCallback = tt.bind(null, e, n, o, i)),
        t.addEventListener(ce, function (e) {
          e.target === t &&
            (ee.swalCloseEventFinishedCallback(), delete ee.swalCloseEventFinishedCallback);
        });
    },
    lt = (e, t) => {
      setTimeout(() => {
  ...
  var en = Object.freeze({
        ...
        'object' != typeof e[0] || Yt(e[0])
          ? ['title', 'html', 'icon'].forEach((n, o) => {
              ...
              'string' == typeof i || Yt(i)
                ? (t[n] = i)
                : void 0 !== i &&
                  a(`Unexpected type of ${n}! Expected "string" or "Element", got ${typeof i}`);
            })
          : Object.assign(t, e[0]),
        t
      );
    ...
    bindClickHandler: function () {
      (Gt[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'data-swal-template'] =
        this),
  ...
  const An = (t, n, o) =>
    ...
    En = (e, t) =>
      t.focusDeny && J(e.denyButton)
        ...
        : !(!t.focusConfirm || !J(e.confirmButton)) && (e.confirmButton.focus(), !0),
    $n = () => {
